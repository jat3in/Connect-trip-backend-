...
## Deployment Api 
```
https://travel-backend-app-4j1v.onrender.com
```
...
```
https://travel-backend-app-4j1v.onrender.com/api/v1/tourist/register
```

2. Login Tourist Api : POST

```
https://travel-backend-app-4j1v.onrender.com/api/v1/tourist/login
```

3. Logout Tourist Api : POST

```
https://travel-backend-app-4j1v.onrender.com/api/v1/tourist/logout
...
```
https://travel-backend-app-4j1v.onrender.com/api/v1/tourist/update-tourist
```

5. Update Profile of Tourist Api : PATCH

```
https://travel-backend-app-4j1v.onrender.com/api/v1/tourist/profile-pic
```

6. Change Current Password Api : PATCH

```
https://travel-backend-app-4j1v.onrender.com/api/v1/tourist/change-password
```

7. Get Current Torist Api : GET

```
https://travel-backend-app-4j1v.onrender.com/api/v1/tourist/current-tourist
```
...
```
https://travel-backend-app-4j1v.onrender.com/api/v1/holiday/get-holiday
```
...
```
https://travel-backend-app-4j1v.onrender.com/api/v1/destination/get-destination/:id
```
...
```
https://travel-backend-app-4j1v.onrender.com/api/v1/accomodation/accomodation
```
...
```
https://travel-backend-app-4j1v.onrender.com/api/v1/activity/get-all-activity/:id
```
...
```
https://travel-backend-app-4j1v.onrender.com/api/v1/package/package
```
...
```
https://travel-backend-app-4j1v.onrender.com/api/v1/transport/get-transport
```
...
```
https://travel-backend-app-4j1v.onrender.com/api/v1/reveiw/get-reveiw
```
...
```
https://travel-backend-app-4j1v.onrender.com/api/v1/booking/create-booking
```
...
```
https://travel-backend-app-4j1v.onrender.com/api/v1/booking/delete-booking/:id
```
...
```
https://travel-backend-app-4j1v.onrender.com/api/v1/flight/location/?from=&to=
```