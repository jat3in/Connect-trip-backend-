...
import { packagePriceCalculator } from "../middlewares/packagePrice.middleware.js";

const router = Router();

router.route("/create-package").post(verifyJwt, packagePriceCalculator, createPackage);
